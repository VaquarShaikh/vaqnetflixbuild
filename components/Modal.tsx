        ...
        <>
            ...
            <div className='absolute bottom-10 flex w-full items-center justify-between px-10'>
              <div className='flex space-x-2'>
                ...
                <button className='modalButton hover:bg-[#444343]'>
              ...
              <button className='modalButton hover:bg-[#444343]' onClick={() => setMuted(!muted)}>
                {muted ? (
            ...
            <div className='flex space-x-10 rounded-b-md bg-[#181818] px-10 py-8'>
